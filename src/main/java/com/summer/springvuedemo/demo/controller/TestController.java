...
import com.summer.springvuedemo.demo.service.impl.DataProcess;
...
//        Map<String,Object> jsonMap = objectMapper.readValue(this.run(),new TypeReference<Map <String,Object >>(){});
//        String res=StringEscapeUtils.unescapeJavaScript(jsonMap.get("data").toString());

//        System.out.println(res);
        return process.fromTencentApi();
    }
//
//    public String run() {
//
